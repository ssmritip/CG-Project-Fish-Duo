...
GLfloat upperCurve1[3][3] = { {-2.5, 4.5, 1.0}, {-1.5, 5.7, 1.0}, {-0.5, 4.5, 1.0} };
GLfloat lowerCurve1[3][3] = { {-2.5, 4.5, 1.0}, {-1.5, 3.2, 1.0}, {-0.5, 4.5, 1.0} };

// coordinates of fish 2
GLfloat upperCurve2[3][3] = { {-1.3, 2.8, 1.0}, {0.0, 3.95, 1.0}, {1.3, 2.8, 1.0} };
GLfloat lowerCurve2[3][3] = { {-1.3, 2.8, 1.0}, {0.0, 1.75, 1.0}, {1.3,2.8, 1.0} };
...
GLfloat tankCoord[4][2] = {{-5.25, 0.18},	//front glass
						   ...
						   {5.25, 6.8},
						   {5.25, 0.18}},
		tankCoord1[4][2] = {{-4.5, 0.6},	//back glass
						   {-4.5, 7.5},
						   {4.5, 7.5},
						   {4.5, 0.6}},
